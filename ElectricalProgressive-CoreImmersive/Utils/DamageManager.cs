...
namespace ElectricalProgressive.Utils
{
    ...
    public class DamageManager
    {
        ...
        public static global::ElectricalProgressiveImmersive.ElectricalProgressiveImmersive? System;
        ...
        public DamageManager(ICoreServerAPI api)
        {
            ...
            // Получаем ссылку на систему ElectricalProgressiveImmersive, если она есть
            System = _sapi!.ModLoader.GetModSystem<global::ElectricalProgressiveImmersive.ElectricalProgressiveImmersive>();
        }
            ...
            ICoreServerAPI sapi, Vec3d tmpPos, BlockPos pos)
        {
            ...
            if (sapi != null)
            {
                ...
                var precip = ElectricalProgressiveImmersive.WeatherSystemServer!.GetPrecipitation(tmpPos);
        ...
        {
            if (System == null) // Если система ElectricalProgressiveImmersive не инициализирована, ничего не делаем
                return;
            ...
            if (now - last >= DamageIntervalMs)
            {
                ...
                //воспроизводим звук
                world.PlaySoundAt(
                    ElectricalProgressiveImmersive.soundElectricShok,
