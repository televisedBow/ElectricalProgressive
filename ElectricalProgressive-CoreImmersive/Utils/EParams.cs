...
namespace ElectricalProgressiveImmersive.Utils
{
    ...
    {
        private static int maxSecBeforeBurnout = ElectricalProgressiveImmersive.timeBeforeBurnout; //максимальное время в секундах до сгорания проводника
        private static int maxTicksBeforeBurnout = maxSecBeforeBurnout*ElectricalProgressiveImmersive.speedOfElectricity; //максимальное количество тиков до сгорания проводника 
