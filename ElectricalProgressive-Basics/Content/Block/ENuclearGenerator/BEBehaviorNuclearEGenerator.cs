...
public class BEBehaviorNuclearEGenerator : BlockEntityBehavior, IElectricProducer
{
    ...
    public BEBehaviorNuclearEGenerator(BlockEntity blockEntity) : base(blockEntity)
    {
    ...
    public void Update()
    {
        if (Blockentity is not BlockEntityENuclearGenerator entity ||
    ...
    public float Produce_give()
    {
        ...
        if (Blockentity is not BlockEntityENuclearGenerator temp)
        {
            return 0f;
        }
