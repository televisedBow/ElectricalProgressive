...
public class InventoryNuclearGenerator : InventoryBase, ISlotProvider
{
    private ItemSlot[] slots;

    public ItemSlot[] Slots => this.slots;

    public InventoryNuclearGenerator(string inventoryID, ICoreAPI api)
        : base(inventoryID, api)
    {
        this.slots = this.GenEmptySlots(4);
    }

    public InventoryNuclearGenerator(string className, string instanceID, ICoreAPI api)
