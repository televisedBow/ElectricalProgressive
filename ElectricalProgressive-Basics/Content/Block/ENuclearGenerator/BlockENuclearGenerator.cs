...
public class BlockENuclearGenerator : BlockEBase
{
    /// <summary>
        ...
        ItemStack byItemStack)
    {
        ...
        if (
            ...
            world.BlockAccessor.GetBlockEntity(blockSel.Position) is BlockEntityENuclearGenerator entity
        )
        {
    ...
    public override void OnNeighbourBlockChange(IWorldAccessor world, BlockPos pos, BlockPos neibpos)
    {
        ...
        if (world.BlockAccessor.GetBlockEntity(pos) is BlockEntityENuclearGenerator)
        {
    ...
    public override bool OnBlockInteractStart(IWorldAccessor world, IPlayer byPlayer, BlockSelection blockSel)
    {
        ...
        // получаем блокэнтити
        var bef = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BlockEntityENuclearGenerator;
